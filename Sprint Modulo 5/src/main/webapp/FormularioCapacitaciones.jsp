      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header bg-danger text-white">
            <h2 class="text-center">Formulario de Capacitación</h2>
          </div>
          <div class="card-body">
            <form action="AgregarCapacitaciones" method="post">
                <div class="form-group">
                    <label for="nombre">Nombre:</label>
                    <input type="text" id="nombre" name="nombre_capacitacion" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="correo">Correo electrónico:</label>
                    <input type="email" id="correo" name="correo_capacitacion" class="form-control" required>
                </div>
                <div class="form-group">
				<label for="curso">Curso de interés:</label>
			    <select class="form-select" id="curso" name="curso_capacitacion" required>
			      <option>Fundamentos de Java</option>
